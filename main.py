...
while True:
    ...
    for rect in rects:
        shape=predictor(gray,rect) #from overall points we can get the eye points
        ...
        cv2.drawContours(frame,[rightEyeHull],-1,(0,0,255),1)  #draw red lines across eyes
        ...
        if ear < earThresh:
            ...
            if count>=earFrames:
                ...
                winsound.Beep(frequency,duration)#position,font,size,color,thickness
        else:
            count=0
